...
describe "colour single pixel" do
    context "given X and Y coordinates, fill with colour P"
    ...
    context "given X and Y coordinates, fill with colour G or P"
       it "returns 5 by 4 bitmap grid with colour G or P added" do
           bitmap = {
